...
final class ky_MSSQL {
	...
	public function __construct($hostname, $username, $password, $database,$charset='utf8') {
		...
		mssql_query("SET NAMES '{$charset}'", $this->connection);
		mssql_query("SET CHARACTER SET {$charset}", $this->connection);
		mssql_query("SET CHARACTER_SET_CONNECTION={$charset}", $this->connection);
  	}
	...
	public function exec($sql){
		return $resource = mssql_query($sql, $this->connection);
